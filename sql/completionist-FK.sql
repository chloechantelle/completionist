...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2018 at 08:00 AM
...
INSERT INTO `contract` (`ContractID`, `PaymentDate`, `PaymentAmount`, `TimeGiven`, `GameID`) VALUES
(1, '20/20/10', 100, '', 1),
(14, '4/4/4', 50, '', 3),
(15, '4/4/4', 50, '', 3),
(24, '4/4/4', 50, '1 hour', 0),
(25, '4/4/4', 50, '1 hour', 0),
(26, '546', 546, '54', 0),
(27, '87797', 87997, '8798', 0),
(28, '909', 909, '909', 0);
...
--
ALTER TABLE `contract`
  MODIFY `ContractID` int(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
-- AUTO_INCREMENT for table `contractstatus`
--
ALTER TABLE `contractstatus`
  MODIFY `StatusID` int(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
